      ...
      <div>
        ...
        <div>
          {selectedProduct.length === 0 ? (
            <p className="text-center text-3xl text-customPurple mt-10">Your cart is empty.</p>
          ) : (
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center w-80">
            ...
            <button
              ...
              className="mt-4 px-4 py-2 bg-gray-200 rounded-lg font-semibold text-gray-600 hover:bg-gray-300"
            >
              Close
            </button>
          </div>
